      ...
      <div class="info text-white p-3 h-100 d-flex flex-column jc-end">
        ...
        <div class="d-flex jc-between pt-2">
          <div class="scores d-flex ai-center" v-if="model.scores">
            ...
            <span>生存</span>
            <span class="badge bg-dark">{{ model.scores.survival }}</span>
          </div>
      ...
      <swiper>
        <swiper-slide>
          <div>
            <div class="p-3 bg-white border-bottom">
              <div class="d-flex">
                ...
                <router-link tag="button" to="/" class="btn btn-lg flex-1 ml-2">
                  <i class="iconfont icon-image-circle"></i>
                  英雄介绍视频
                </router-link>
              </div>
              ...
              <div class="skills bg-white mt-4">
                ...
                <div v-if="currentSkill">
                  ...
                  <p class="text-grey-1" v-if="currentSkill.tips">
            ...
            <m-card plain :icon="'icon-icon'" title="使用技巧">
              <p class="m-0">{{ model.usageTip }}</p>
            </m-card>
            <m-card plain :icon="'icon-jiqiaomiji'" title="对抗技巧">
              <p class="m-0">{{ model.battleTip }}</p>
            </m-card>
            <m-card plain :icon="'icon-chuzhisilu'" title="团战思路">
              <p class="m-0">{{ model.teamTip }}</p>
            </m-card>
            <m-card plain :icon="'icon-guanxi'" title="英雄关系">
